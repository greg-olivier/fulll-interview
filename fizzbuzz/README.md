...
#### Exécution
1. Naviguez vers le dossier `fizzbuzz`
...
- Ouvrez le fichier `FizzBuzz.js`
- Modifiez la valeur passée en paramètre à la fonction `fizzbuzz()`
- Sauvegardez et relancez le script